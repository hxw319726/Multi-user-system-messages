...
<div id="message">
    ...
    <input type="hidden" class="text" name="touser" value="<?php echo $_html['touser'];?>"/>
        <dl>
            <dd>
                <input type="text" class="text" readonly="readonly" value="<?php echo 'To:'.$_html['touser'];?>"/>
                <select name="flower" >
                  <?php 
            ...
            <dd><textarea name="content">我来送花啦。我来送花啦。我来送花啦。我来送花啦。我来送花啦。</textarea></dd>
            <dd><span>验证码:</span><input type="text" name="yzm" class="text yzm"/><img src='
            code.php'id="code"/><input type="submit" name="button" class="submit" value="送花"/></dd>
